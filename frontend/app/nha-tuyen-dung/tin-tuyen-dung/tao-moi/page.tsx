      ...
      <section className="container portal-content editor-layout">
        <form className="content-card editor-form" onSubmit={save}>
          ...
          <div className="form-grid">
            ...
            <label className="form-group"><span>Lương từ (VNĐ)</span><input name="mucLuongTu" type="number" /></label>
            <label className="form-group"><span>Lương đến (VNĐ)</span><input name="mucLuongDen" type="number" /></label>
